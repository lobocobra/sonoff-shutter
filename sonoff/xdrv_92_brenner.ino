...
/*
  xsns_92_brenner.ino - BASED on RELAY.INO, calculate oil in tank
...
\*********************************************************************************************/
// Translation of the new commands
#define D_CMND_LC_Device_Sec_24h  "BrennerSek24h"         // define what is displayed in the MQTT message +extend MQTT mess
#define D_CMND_Brenner_Sec_dayM1  "BrennerSekDay-1"       // define what is displayed in the MQTT message +extend MQTT mess
#define D_CMND_Brenner_OelstandL  "BrennerOelstandL"      // define what is displayed in the MQTT message +extend MQTT mess
#define D_CMND_Brenner_OelstandFr "BrennerOelstandFr"     // define what is displayed in the MQTT message +extend MQTT mess
#define D_CMND_OelVerbLheute      "BrennerOelVerbLheute"  // define what is displayed in the MQTT message +extend MQTT mess
#define D_CMND_OelVerbLgestern    "BrennerOelVerbLgestern"// define what is displayed in the MQTT message +extend MQTT mess
#define D_CMND_LC_Device_SecTTL   "BrennerSekTTL"         // define what is displayed in the MQTT message +extend MQTT mess
#define D_CMND_LC_Device_Cycle    "BrennerCycles"         // define what is displayed in the MQTT message +extend MQTT mess
...
enum RelayCommands { CMND_BRENNERttl, CMND_BRENNERcycle, CMND_BRENNERoelstand, CMND_BRENNERoeltemp, CMND_BRENNERoelverb1000H, CMND_BRENNERoelmaxcapacity, 
                     CMND_BRENNERoelmincapacity, CMND_BRENNERcorrcyclesec, CMND_BRENNERoelprice10000l, CMND_BRENNERpowerprice100kw };
                     
const char kRelayCommands[] PROGMEM =   D_CMND_BRENNERttl "|" D_CMND_BRENNERcycle  "|" D_CMND_BRENNERoelstand "|" D_CMND_BRENNERoeltemp "|" D_CMND_BRENNERoelverb1000H "|" 
                                        D_CMND_BRENNERoelmaxcapacity "|" D_CMND_BRENNERoelmincapacity  "|" D_CMND_BRENNERcorrcyclesec "|" D_CMND_BRENNERoelprice10000l "|" 
                                        D_CMND_BRENNERpowerprice100kw;
...
CMND_BRENNERttl, CMND_BRENNERcycle, CMND_BRENNERoelstand, CMND_BRENNERoeltemp, CMND_BRENNERoelverb1000H, CMND_BRENNERoelmaxcapacity, CMND_BRENNERoelmincapacity, CMND_BRENNERcorrcyclesec, CMND_BRENNERoelprice10000l, CMND_BRENNERpowerprice100kw
